...
import toml
import logging
from message_push import Server_jiang
...
def set_message_type():
    server_jiang_sendkey = jsonpath(config, "$..send_key")[0]
    ...
    if server_jiang_sendkey:
        return partial(Server_jiang(server_jiang_sendkey).send_message, "联想签到")
